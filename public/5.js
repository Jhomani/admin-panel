  ...
  methods: {
    handleLogin: function handleLogin() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var _this$form, email, password, res;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this$form = _this.form, email = _this$form.email, password = _this$form.password;
                ...
                return _context.abrupt("return", _this.$Notice.error({
                  title: 'complete email and password',
                  desc: ''
                }));
              ...
              case 4:
                ...
                return _context.abrupt("return", _this.$Notice.error({
                  title: 'Hey!',
                  desc: 'the password should be more then 6 letters.'
                }));

              case 6:
                _context.next = 8;
                return _this.callApi('post', 'app/admin_login', _this.form);
            ...
            [
              _c(
                ...
                [
                  _vm._v(
                    "\n          " +
                      _vm._s(_vm.isLoading ? "Editing..." : "Login") +
                      "\n        "
                  )
                ]
              )
