        ...
        <div class="_1side_menu_content">
          ...
          <div class="_1side_menu_list">
            <ul class="_1side_menu_list_ul">
              ...
              <li><router-link to="/providers"><Icon type="ios-speedometer" /> Providers</router-link></li>
              ...
              <!-- <li><router-link to="/"><Icon type="ios-speedometer" /> Role Management</router-link></li> -->
              <!-- <li><router-link to="assignRole"><Icon type="ios-speedometer" /> Assign role</router-link></li> -->


              <li><a href="/user/logout"><Icon type="ios-speedometer" />Logout</a></li>
            </ul>
          </div>
        </div>
      </div>
